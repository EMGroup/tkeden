...
int Tcl_AppInit(Tcl_Interp * interp)
{
    ...
    Tcl_CreateCommand(interp, "quit", quitCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "evaluate", evaluateCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "eden", edenCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "weden", wedenCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "todo", todoCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "refresh", refreshCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "goto", gotoCmd, NULL, NULL);
    Tcl_CreateCommand(interp, "dumpeden", dumpeden, NULL, NULL);
    Tcl_CreateCommand(interp, "dumpscout", dumpscout, NULL, NULL);
    Tcl_CreateCommand(interp, "dumpdonald", dumpdonald, NULL, NULL);
    Tcl_CreateCommand(interp, "setupViewOptions", viewOptions, NULL, NULL);
    Tcl_CreateCommand(interp, "interrupt", eden_interrupt_handler, NULL, NULL);
    Tcl_CreateCommand(interp, "restart", restartCmd, NULL, NULL);
#ifdef DISTRIB
    Tcl_CreateCommand(interp, "dumpLSD", dumpLSD, NULL, NULL);
    Tcl_CreateCommand(interp, "getOldNotation", getNotation, NULL, NULL);
    Tcl_CreateCommand(interp, "getCurrentNotation", getNotation, NULL, NULL);
#endif /* DISTRIB */
